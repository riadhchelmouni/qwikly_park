...
import { darkPrimaryColor, lightPrimaryColor } from "@/plugins/vuetify/theme";
...
const resetCustomizer = async () => {
  vuetifyTheme.themes.value.light.colors.primary = lightPrimaryColor;
  vuetifyTheme.themes.value.dark.colors.primary = darkPrimaryColor;
      ...
      <div class="customizer-heading d-flex align-center justify-space-between">
        ...
        <div class="d-flex align-center gap-1">
          <VBtn icon variant="text" size="small" color="medium-emphasis" @click="resetCustomizer">
            <VBadge v-show="isCookieHasAnyValue" dot color="error" offset-x="-30" offset-y="-15" />
      ...
      <PerfectScrollbar tag="ul" :options="{ wheelPropagation: false }">
        ...
        <CustomizerSection title="Theming" :divider="false">
          ...
          <div class="d-flex flex-column gap-3">
            <h6 class="text-base font-weight-medium">Primary Color</h6>

            <div class="d-flex align-center gap-x-3" style="column-gap: 0.7rem;">
              <div
          ...
          <!-- 👉 Theme -->
          <div class="d-flex flex-column gap-3">
            <h6 class="text-base font-weight-medium">Theme</h6>
          ...
          <!-- 👉 Skin -->
          <div class="d-flex flex-column gap-3">
            <h6 class="text-base font-weight-medium">Skins</h6>
          ...
          >
            <VLabel for="customizer-semi-dark" class="text-high-emphasis">Semi Dark Menu</VLabel>
