...
export const createLayouts = userConfig => {
  return () => {
    ...
    layoutConfig.app.logoDark = userConfig.app?.logoDark ?? layoutConfig.app.logoDark
    layoutConfig.app.logoLight = userConfig.app?.logoLight ?? layoutConfig.app.logoLight
