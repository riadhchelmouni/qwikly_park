<template>
  ...
  >
    <AppDrawerHeaderSection title="Nouvelle Actualité" @cancel="close" />
            ...
            <VRow>
              ...
              <VCol cols="12">
                ...
                <div class="img-upload-zone" @click="$refs.imgInput.click()">
                  ...
                  <div v-else class="img-upload-empty">
                    ...
                    <span class="img-hint-inner">Cliquer pour ajouter une image</span>
                  </div>
                </div>
              ...
              <VCol cols="12">
                <div class="d-flex align-center justify-space-between mb-1">
                  <p class="field-label">Parc(s) concerné(s) <span style="color:#e53935">*</span></p>
                  <button type="button" @click="form.park_ids = parcOptions.map(p=>p.id)"
                    style="font-size:11px;color:#E8A838;font-weight:700;background:none;border:none;cursor:pointer">
                    Tout sélectionner
                  </button>
                </div>
                <AppSelect
    ...
    save() {
      this.$refs.addForm.validate().then(({ valid }) => {
        ...
        $api("/news", { method: "POST", body: fd })
          ...
          .catch(() => {
            this.loading = false;
            this.snackBar = { message: "Impossible de créer l'actualité.", color: "error" };
