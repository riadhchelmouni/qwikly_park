...
export default {
  ...
  data() {
    return {
      statistics: [
        {
          title: "Nombre total de employés",
          stats: "0",
          icon: "tabler-users",
          color: "success"
        },
        {
          title: "Nombre de employés approuvés",
          stats: "0",
          icon: "tabler-user-check",
          color: "info"
        },
        {
          title: "Nombre de employés en attente",
          stats: "0",
          icon: "tabler-user-pause",
          color: "warning"
        },
        {
          title: "Nombre de employés refusés",
          stats: "0",
  ...
  methods: {
    async getCount() {
      new Promise((resolve, reject) => {
        axios
          .get(import.meta.env.VITE_BASE_URL + "/employees/count", {
            headers: {
