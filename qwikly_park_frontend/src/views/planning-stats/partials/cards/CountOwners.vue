  ...
  data() {
    return {
      statistics: [
        ...
        {
          title: "Nombre de propriétaires approuvés",
          stats: "0",
          icon: "tabler-user-check",
          color: "info"
        },
        {
          title: "Nombre de propriétaires en attente",
          stats: "0",
          icon: "tabler-user-pause",
          color: "warning"
        },
        {
          title: "Nombre de propriétaires refusés",
          stats: "0",
  ...
  methods: {
    async getCount() {
      new Promise((resolve, reject) => {
        axios
          .get(import.meta.env.VITE_BASE_URL + "/owners/count", {
            headers: {
