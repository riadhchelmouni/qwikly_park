      ...
      <VCard flat v-if="current">
        <VCardText>
          <VList lines="two" class="py-0">
            ...
            <VListItem class="px-0">
              <p class="font-weight-bold mb-1">{{current.roles.map(role => role.name).join(', ')}}</p>
              <VListItemSubtitle>Rôle</VListItemSubtitle>
            </VListItem>

            <VListItem class="px-0">
              <p class="font-weight-bold mb-1">{{current.owner.company}}</p>
            ...
            <VListItem class="px-0">
              ...
              >{{current.owner.firstname + " " + current.owner.lastname}}</p>
              <VListItemSubtitle>Propriétaire</VListItemSubtitle>
            </VListItem>
