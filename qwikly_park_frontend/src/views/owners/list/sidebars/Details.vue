      ...
      <VCard flat v-if="current">
        <VCardText>
          <VList lines="two" class="py-0">
            ...
            <VListItem class="px-0" v-if="current.company">
              <p class="font-weight-bold mb-1">{{current.company}}</p>
              <VListItemSubtitle>Entreprise</VListItemSubtitle>
            </VListItem>

            <VListItem class="px-0" v-if="current.company_id">
              <p class="font-weight-bold mb-1">{{current.company_id}}</p>
              <VListItemSubtitle>L’identifiant de l’Entreprise</VListItemSubtitle>
            </VListItem>
            ...
            <VListItem class="px-0">
              ...
              <VListItemSubtitle>Adresse</VListItemSubtitle>
            </VListItem>
            ...
            <VListItem class="px-0">
              ...
              <VListItemSubtitle>Employés</VListItemSubtitle>
            </VListItem>
            ...
            <VListItem class="px-0">
              <v-chip
                :color="current.sms ? 'success' : 'warning'"
                class="text-capitalize mb-1"
              >{{ current.sms ? 'Activé' : 'Désactivé' }}</v-chip>
              <VListItemSubtitle>Réception des SMS</VListItemSubtitle>
            </VListItem>
          </VList>
        </VCardText>
      </VCard>
